...
const WhatsAppButton = ({ productName, productPrice, productUrl }: WhatsAppButtonProps) => {
  ...
  return (
    <a
      ...
      className="fixed bottom-20 lg:bottom-6 right-4 z-50 flex items-center justify-center h-14 w-14 rounded-full bg-[#25D366] text-white shadow-lg hover:scale-110 transition-transform duration-200"
    >
