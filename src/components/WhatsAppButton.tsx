...
const WhatsAppButton = ({ productName, productPrice, productUrl }: WhatsAppButtonProps) => {
  ...
  return (
    <a
      ...
      className="group fixed bottom-36 lg:bottom-24 right-4 z-50 flex items-center gap-2 h-12 rounded-full bg-[#25D366] text-white shadow-lg hover:scale-105 transition-all duration-200 px-3"
    >
      <svg viewBox="0 0 32 32" className="h-6 w-6 shrink-0 fill-white" xmlns="http://www.w3.org/2000/svg">
      ...
      <span className="max-w-0 overflow-hidden group-hover:max-w-[6rem] transition-all duration-300 text-xs font-semibold whitespace-nowrap">WhatsApp</span>
    </a>
  );
};
